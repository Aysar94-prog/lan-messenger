...
Reviewed 2026-09-26. Release: **0.8.12** (unified with Android's version number as of this release). See the [platform comparison](../PROJECT_STATUS.md).
...
- Results: `D:/LAN-Messenger/outputs/.build/windows-0810-ui`, earlier 0.8.9 results in `windows-ui-tests`, and `windows-chatperf-measure`. Package: `D:/LAN-Messenger/outputs/LanMessenger-Windows-0.8.12.zip` (requires .NET 9 Desktop Runtime).
- Windows 0.8.9 code commit: `2241347`; 0.8.10 hotfix, the 0.8.11 file-split/delete-conversation work, and the 0.8.12 forget-notice/group-re-invite work committed locally on `master`, not pushed.
